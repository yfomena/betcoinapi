...
import com.betcoin.backend.repository.GameRepository;
import com.betcoin.backend.service.GameService;
...
public class GameResourceIntTest {
    ...
    public void createGame() throws Exception {
        ...
        assertThat(testGame.getMatchDate()).isEqualTo(DEFAULT_MATCH_DATE);
        assertThat(testGame.getScoreHome()).isEqualTo(DEFAULT_SCORE_HOME);
        assertThat(testGame.getScoreAway()).isEqualTo(DEFAULT_SCORE_AWAY);
    }
    ...
    public void updateGame() throws Exception {
        ...
        Game testGame = gameList.get(gameList.size() - 1);
        assertThat(testGame.getMatchDate()).isEqualTo(UPDATED_MATCH_DATE);
        assertThat(testGame.getScoreHome()).isEqualTo(UPDATED_SCORE_HOME);
        assertThat(testGame.getScoreAway()).isEqualTo(UPDATED_SCORE_AWAY);
    }
