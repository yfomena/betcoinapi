...
public class TeamResourceIntTest {
    ...
    private static final String DEFAULT_COLOR_HOME = "AAAAAAAAAA";
    private static final String UPDATED_COLOR_HOME = "BBBBBBBBBB";

    private static final String DEFAULT_COLOR_AWAY = "AAAAAAAAAA";
    private static final String UPDATED_COLOR_AWAY = "BBBBBBBBBB";
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team()
            ...
            .colorHome(DEFAULT_COLOR_HOME)
            .colorAway(DEFAULT_COLOR_AWAY);
        return team;
    }
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getColorHome()).isEqualTo(DEFAULT_COLOR_HOME);
        assertThat(testTeam.getColorAway()).isEqualTo(DEFAULT_COLOR_AWAY);
    }
    ...
    public void getAllTeams() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].colorHome").value(hasItem(DEFAULT_COLOR_HOME.toString())))
            .andExpect(jsonPath("$.[*].colorAway").value(hasItem(DEFAULT_COLOR_AWAY.toString())));
    }
    ...
    public void getTeam() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams/{id}", team.getId()))
            ...
            .andExpect(jsonPath("$.colorHome").value(DEFAULT_COLOR_HOME.toString()))
            .andExpect(jsonPath("$.colorAway").value(DEFAULT_COLOR_AWAY.toString()));
    }
    ...
    public void updateTeam() throws Exception {
        ...
        updatedTeam
            ...
            .colorHome(UPDATED_COLOR_HOME)
            .colorAway(UPDATED_COLOR_AWAY);
        ...
        assertThat(testTeam.getColorHome()).isEqualTo(UPDATED_COLOR_HOME);
        assertThat(testTeam.getColorAway()).isEqualTo(UPDATED_COLOR_AWAY);
    }
